...
@section('content')
    <div class="container mt-5">
        ...
        <div class="col-8 mx-auto">
                    ...
                    <form class="needs-validation" novalidate action="{{ route('admin.profiles.update', auth()->user()->id) }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-3">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror" type="email"
                                value="{{ old('email', $profile->email) }}" id="email" name="email" required autocomplete="email">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mt-3">
                            ...
                            <input class="form-control @error('address') is-invalid @enderror" type="text"
                                value="{{ old('address', $profile->user_detail?->address) }}" id="address" name="address" required
                        ...
                        <div class="mt-3">
                            ...
                            <input class="form-control" type="text"
                                value="{{ old('description', $profile->user_detail?->description) }}" id="description"
                                name="description">
                        </div>
            
                        <div class="mt-3">
                            <h6>Specializzation:*</h6>
