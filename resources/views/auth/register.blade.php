                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-6">
                                <select id="specialization" type="select" class="form-select @error('specialization') is-invalid @enderror" name="specialization" value="{{ old('specialization') }}" required autocomplete="specialization">
                                    <option value=""></option>
